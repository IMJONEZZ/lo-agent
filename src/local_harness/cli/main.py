...
def build_parser() -> argparse.ArgumentParser:
    ...
    down.add_argument("--timeout", type=float, default=10.0, help="seconds to wait for SIGTERM before SIGKILL")
    down.add_argument("--force", action="store_true", help="also stop a sidecar `up` reused rather than started")
